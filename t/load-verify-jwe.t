...
=== TEST 13: Use rsa oeap for encryption
--- http_config eval: $::HttpConfig
--- config
    location /t {
        content_by_lua '
...
=== TEST 14: Use rsa oeap for encryption invalid typ
--- http_config eval: $::HttpConfig
--- config
    location /t {
        content_by_lua '
...
=== TEST 15: Use rsa oeap for encryption invalid key
--- http_config eval: $::HttpConfig
--- config
    location /t {
        content_by_lua '
...
=== TEST 16: Use rsa oeap for encryption invalid enc algo
--- http_config eval: $::HttpConfig
--- config
    location /t {
        content_by_lua '
...
=== TEST 17: Use rsa oeap for encryption with custom payload encoder/decoder
--- http_config eval: $::HttpConfig
--- config
    location /t {
        content_by_lua '
...
=== TEST 18: Use rsa oeap with aes-256-gcm for encryption
--- http_config eval: $::HttpConfig
--- config
    location /t {
        content_by_lua '
...
=== TEST 19: verify jwe create with rsa-oaep and aes-256-gcm with invalid tag
--- http_config eval: $::HttpConfig
--- config
    location /t {
        content_by_lua '
